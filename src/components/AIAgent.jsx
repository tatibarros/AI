...
import { callAnthropicAPI, isUsingMock } from "../services/anthropicMock";
  ...
  const runAgent = async (userText) => {
    ...
    while (iteration < MAX_ITER) {
      ...
      try {
        ...
        addStep("error", "Erro: " + err.message);
        break;
      }
    ...
    <div style={styles.root}>
      ...
      <footer style={styles.footer}>
        ...
        <span style={styles.footerNote}>
          {usingMock ? "🟢 MOCK MODE" : "🔵 API REAL"} · claude-sonnet-4 · ReAct Loop · max 6 iter
        </span>
      </footer>
    </div>
  );
